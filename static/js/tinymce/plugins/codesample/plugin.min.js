    ...
    r("tinymce/codesampleplugin/Prism", [], function () {
                        ...
                        for (var c = 0; c < l.length; ++c) {
                            ...
                            for (var h = 0; h < o.length; h++) {
                                ...
                                if (!(g instanceof i)) {
                                    ...
                                    if (v) {
                                        f && (p = v[1].length);
                                        var y = v.index - 1 + p, v = v[0].slice(p), b = v.length, x = y + b, C = g.slice(0, y + 1), w = g.slice(x + 1), N = [h, 1];
                                        C && N.push(C);
        ...
        return "undefined" != typeof module && module.exports && (module.exports = n), "undefined" != typeof global && (global.Prism = n), n.languages.markup = {
            ...
            style: {
                ...
                inside: {
                    tag: {pattern: /<style[\w\W]*?>|<\/style>/i, inside: n.languages.markup.tag.inside},
            ...
            script: {
                ...
                inside: {
                    tag: {pattern: /<script[\w\W]*?>|<\/script>/i, inside: n.languages.markup.tag.inside},
                    rest: n.languages.javascript
                },
        ...
        var s = e.DOM, l = [{text: "HTML/XML", value: "markup"}, {
            text: "JavaScript",
            value: "javascript"
