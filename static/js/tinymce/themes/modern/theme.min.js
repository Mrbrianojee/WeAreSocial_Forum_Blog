tinymce.ThemeManager.add("modern", function (e) {
    function t(t, n) {
        ...
        }), {type: "toolbar", layout: "flow", items: i}
    }
    ...
    function r() {
        ...
        function n(n) {
            ...
            if (s = tinymce.makeMap((d.removed_menuitems || "").split(/[ ,]/)), d.menu ? (i = d.menu[n], a = !0) : i = v[n], i) {
                r = {text: i.title}, o = [], p((i.items || "").split(/[ ,]/), function (e) {
                    var n = t(e);
                    n && !s[e] && o.push(t(e))
        ...
        var r, i = [], o = [];
        if (d.menu)for (r in d.menu)o.push(r); else for (r in v)o.push(r);
    ...
    function l(t) {
        function o() {
            if (p && p.moveRel && p.visible() && !p._fixed) {
                var t = e.selection.getScrollContainer(), n = e.getBody(), r = 0, i = 0;
                if (t) {
                    var o = m.getPos(n), a = m.getPos(t);
    ...
    function c(t) {
        ...
        return t.skinUiCss && tinymce.DOM.loadCSS(t.skinUiCss), l = u.panel = f.create({
            ...
            type: "resizehandle", direction: d.resize, onResizeStart: function () {
            ...
            l.remove(), l = null
        }), i(l), s(), {iframeContainer: l.find("#iframe")[0].getEl(), editorContainer: l.getEl()}
    }

    var u = this, d = e.settings, f = tinymce.ui.Factory, p = tinymce.each, m = tinymce.DOM, h = tinymce.geom.Rect, g = tinymce.ui.FloatPanel, v = {
        file: {
            title: "File",
            items: "newdocument"
        },
